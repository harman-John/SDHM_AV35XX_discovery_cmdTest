...
public class FunctionTestSDHM {
    private final static String TAG = FunctionTestSDHM.class.getSimpleName();
    private static FunctionTestSDHM instance;
    private LightX mLightX;

    public static FunctionTestSDHM getInstance(){
        if (instance == null) {
            instance = new FunctionTestSDHM();
        }
        return instance;
    }
